...
namespace Sesija
{
    public class Broker
    {
        ...
        public void otvoriKonekciju()
        {
            try
            {
                konekcija = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Branko\Desktop\PS projektni kafic\Kafic.accdb");
                konekcija.Open();
            }
            catch (Exception)
            {
        ...
        public void zatvoriKonekciju()
        {
            ...
            {
                throw new Exception("Nije moguće zatvoriti konekciju!");
            }
        }
        ...
        public void zapocniTransakciju()
        {
            ...
            {
                throw new Exception("Neuspešna transakcija!");
            }
        }
        ...
        public void ponistiTransakciju()
        {
            ...
            {
                throw new Exception("Neuspešno poništavanje!");
            }
        }
        ...
        public void potvrdiTransakciju()
        {
            ...
            {
                throw new Exception("Neuspešna potvrda transakcije!");
            }
        }
        ...
        public int dajID(OpstiDomenskiObjekat odo)
        {
